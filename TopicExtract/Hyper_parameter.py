...
parser.add_argument('--load_pkl',  default=True, type=bool, required=False,
                    help='whether the pkl file is available')

parser.add_argument('--pkl_path',  default=r'F:\python_code\NLPTools\pkl\topic.pkl',
                    type=str, required=False,
                    help='')

parser.add_argument('--file_path',
                    default=r'F:\python_code\NLPTools\data\THUCNews.csv',
                    type=str, required=False,
                    help='')
...
parser.add_argument('--num_classes',  default=10, type=int, required=False,
                    help='')
